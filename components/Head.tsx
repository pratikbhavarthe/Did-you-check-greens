...
export function Head({
  ...
  return (
    <NextHead>
      <title>
        {typeof title === "string" ? `${title} | ` : ""} Did You Check Greens?
      </title>
      ...
      <meta
        ...
        content={
          typeof title === "string"
            ? `${title} | Did You Check Greens?`
            : "Did You Check Greens?| Check if a plant is unsafe to an animal"
        }
        key="og:title"
      />
      <meta
